...
public:
   ...
   // Sends up to Len bytes of data and returns the amount sent - or
   // SOCKET_ERROR if it times out
   int SendPartial(LPCVOID lpBuf, const ULONG Len);
   // Receives exactly Len bytes of data and returns the amount sent - or
   // SOCKET_ERROR if it times out
   int RecvMsg(LPVOID lpBuf, const ULONG Len);
   // Sends exactly Len bytes of data and returns the amount sent - or
   // SOCKET_ERROR if it times out
