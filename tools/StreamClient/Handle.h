#pragma once
// Based on Kenny Kerr's handle class from 2011 -
...
//	{
//		return Traits::invalid() != m_value ? &boolean_struct::member :
// nullptr;
//	}
...
//};
//
// class ConstCertContextHandle : public unique_handle<PCCERT_CONTEXT,
// CertContextTraits>
//{
//};
//
...
template <typename T> struct HandleTraits {
   ...
   constexpr static Type Invalid() noexcept { return nullptr; }
...
public:
   ...
   explicit operator bool() const noexcept { return m_value != T::Invalid(); }

   friend Type get(Handle const & handle) noexcept { return handle.m_value; }
